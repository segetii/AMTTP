"""Benchmark MolecularEngine with paper-correct Algorithm 1 damping."""
...
ENGINES = {
    'Molecular (Alg1 damping)':  {'use_bsdt_damping': True},
    'Molecular (no damping)':    {'use_bsdt_damping': False},
}
...
for eng_name, extra_kw in ENGINES.items():
    ...
    kwargs = dict(iterations=80, k_neighbors=10, max_samples=2000, **extra_kw)
