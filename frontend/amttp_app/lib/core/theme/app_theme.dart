...
class AppTheme {
  ...
  static const Color tokenSurfaceDeep = Color(0xFF0F172A);    // Deeper cards (slate-950)
  static const Color tokenCardElevated = Color(0xFF1A1A2E);   // Elevated cards, popups
  ...
  static const Color tokenGradientDark = Color(0xFF0F0F2D);   // Wallet card bottom
  ...
  static List<BoxShadow> shadowGlow(Color color) => [
    BoxShadow(color: Color.fromRGBO(color.r.toInt(), color.g.toInt(), color.b.toInt(), 0.35), blurRadius: 20, offset: const Offset(0, 8)),
  ];
