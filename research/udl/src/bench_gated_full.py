"""
Full 7-dataset benchmark: Gated adaptive stretching
=====================================================
Confirmed on 4 datasets that gate-based approach works.
Now run all 7 for definitive mAUC comparison.
"""
...
# ══════════════════════════════════════════════════════════════
print("\n\n" + "="*100)
print("  GATED ADAPTIVE STRETCHING — FULL 7-DATASET RESULTS")
print("="*100)

methods = ["BR-raw", "BR-gate-γ3", "SubMF-raw", "SubMF-gate-γ3"]
...
with open("results/gated_adaptive_full.json", "w") as f:
    json.dump(results, f, indent=2)
print(f"\nSaved to results/gated_adaptive_full.json")
