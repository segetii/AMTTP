...
\begin{tablenotes}\small
  ...
  \item[$\dagger$] Wilcoxon signed-rank test ($n{=}15$, 3 real datasets~$\times$~5 folds, UDL-RankFusion vs.\ baselines): UDL is statistically significant vs.\ LOF ($p{=}0.028$); differences vs.\ IForest, COPOD, HBOS are not significant at $\alpha{=}0.05$.
\end{tablenotes}
\end{threeparttable}
\end{table*}
