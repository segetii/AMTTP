"""Overwrite test_bsdt_variants.py with closed-form tests."""

CONTENT = r'''"""Tests for BSDT scoring variants (all closed-form, zero label leakage):
...
with open(r'c:\amttp\research\udl\tests\test_bsdt_variants.py', 'w') as f:
    f.write(CONTENT)
