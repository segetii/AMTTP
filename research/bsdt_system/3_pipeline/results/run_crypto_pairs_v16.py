"""
Crypto BSDT v16 — BSDT vector geometry (φ direction-change + collapse alignment)
================================================================================
...
def main():
    ...
    results = {
        "model":   "Crypto BSDT v16 — BSDT vector geometry (φ + collapse alignment)",
        "version": "v16",
        "gamma_stats": {
    ...
    import os
    out_path = os.path.join(OUT_DIR, "crypto_bsdt_v16_results.json")
