...
\item \textbf{3D vortex stretching diagnostics.}  The
  $N=256$ run (Section~\ref{app:ns:resolution}) computes
  mean alignment $|\cos\angle(\bm{\omega}, S\bm{\omega})|
  = 0.098$ and max stretching $|\omega_i S_{ij}\omega_j|
  = 18.91$---both finite and consistent with classical
  turbulence.  Incorporating these into the $\delta_A$
  channel (currently $\equiv 0$) and assessing additional
