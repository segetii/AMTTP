...
\begin{enumerate}
  ...
  \item A \textbf{compliance orchestration engine} comprising
    ...
    termination, RS256~JWT validation, per-key rate limiting, and
    Ed25519~oracle-signed responses with 90-day key rotation.
...
and his BSDT research on Zenodo
...
Decomposition Theory, the Universal Deviation Law, and an Adaptive
